...
with pestañas_principales[0]:
    ...
    <div class='welcome-card'>
        ...
        <p style='margin:0; opacity:0.9;'>Módulo actual: <b>{modulo_actual}</b>. Registra y sintetiza tus clases en tiempo real con Gemini 3.6 Flash.</p>
    </div>
