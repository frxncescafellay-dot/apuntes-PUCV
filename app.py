...
# --- ESTILOS VISUALES SKILLPATH CON FORZADO TOTAL DE PESTAÑAS ---
st.markdown("""
<style>
...
/* ==========================================================================
   SOBREESCRITURA TOTAL DE PESTAÑAS (TABS) - NUNCA MÁS BLANCAS O INVISIBLES
   ========================================================================== */
...
[data-testid="stTabs"] [data-baseweb="tab-list"] {
    gap: 8px !important;
    border-bottom: 2.5px solid #c4b5fd !important;
...
/* 1. TODAS LAS PESTAÑAS INACTIVAS (COLOR MORADO OSCURO 100% OPACO) */
...
/* Forzado de color en CUALQUIER elemento interno */
[data-testid="stTabs"] button[role="tab"] *,
[data-testid="stTabs"] button[data-baseweb="tab"] *,
